...
\photo[noedge]{school.png}
\name{ZHOU}{Yicheng}
% \position{Site Reliability Engineer{\enskip\cdotp\enskip}Software Architect}
% \address{235, Wo0ld Cup buk-ro, Mapo-gu, Seoul, 03936, Republic of Korea}

\mobile{(+86) 158-1505-9282}
\email{zhou\_yicheng@foxmail.com}
\dateofbirth{March 21st, 2000}
